...
from PML_base.PMLFun import PMLFunctions
from PML_base.PoroelasticProblems import MixedPMLProblem
...
if __name__=="__main__":
  ...
  parameters = Set4(V=P, layers=layers)

  # Set up boundary condition
  uD_1 = Constant(("0.0", "0.0"))
  wD_1 = Constant(("0.0", "0.0"))
  pD_1 = Constant("0.0")
  ...
  # Define problem
  problem = MixedPMLProblem(mesh=mesh,
