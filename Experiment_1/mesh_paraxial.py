...
if __name__ == '__main__':
  ...
  # Export in xdmf
  meshio.write(path+"mesh_paraxial.xdmf", meshio.Mesh(points=points,
              cells={"triangle": cells}))                      

  meshio.write(path+"mf_paraxial.xdmf", meshio.Mesh(points=points,
              cells={"triangle": cells},
              cell_data={"markers": [cell_data_domains]}))

  meshio.write(path+"mf_paraxial_1.xdmf", meshio.Mesh(points=points,
              cells={"triangle": cells},
              cell_data={"markers": [cell_data_stratas]}))

  meshio.write(path+"ff_paraxial.xdmf", meshio.Mesh(points=geometry.points,
              cells={"line": lines},
